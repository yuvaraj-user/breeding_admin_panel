...
<h6 style="text-align: center;color: blue;">Location Master</h6>


<table id="LocationMaster" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>Sno</th>
            <th>Location</th>
