...
<h6 style="text-align: center;color: blue;">Project Master</h6>

<table id="ProjectMaster" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        <tr>
            <th>Sno</th>
            <th>Project</th>
