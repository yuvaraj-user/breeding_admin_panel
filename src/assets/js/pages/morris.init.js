...
!function ($) {
    ...
    var MorrisCharts = function () {
        ...
        MorrisCharts.prototype.createStackedChart = function (element, data, xkey, ykeys, labels, lineColors) {
            ...
            ChartColorChange(stackedChart, 'morris-bar-stacked');
        }
        ,
        ...
        MorrisCharts.prototype.init = function () {
            ...
            var stackedChartColors = getChartColorsArray("morris-bar-stacked");
            var $stckedData = [
                {y: '2005', a: 45, b: 180},
                {y: '2006', a: 75, b: 65},
                {y: '2007', a: 100, b: 90},
            ...
            this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b'], ['Series A', 'Series B'], stackedChartColors);
