                  ...
                  <input type="hidden" class="Autonumid" name="Autonumid" >     
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <select class="select2 mb-3 select2-single locationvalue" name="location" id="location"   style="width: 100%; height:36px;" data-placeholder="Choose">
...
<div class="modal" id="Assumptionpopup" role="dialog">
    ...
    <form method="POST" class="Assumptionpopup">

    <div class="modal-dialog modal-lg" style="max-width: 600px !important">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-bs-dismiss='modal'>&times;</button>
          <h6 style="color: #b48608; font-family: 'Droid serif', serif; font-size: 15px; font-weight: 400; font-style: italic; line-height: 44px;  text-align: center;margin-right: 221px;">Add Male and Female Count</h6> 
        </div>
                    ...
                    <div class="col-lg-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Project Wise Male Female</h4>
                                <p class="text-muted mb-4 font-13">Fill The Below Details
                                </p>
                                ...
                                <div class="table-responsive">
                                      ...
                                      <table id="datatable" class="table table-bordered dt-responsive nowrap assumptionwise" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              <thead class="" >
                  <tr>                    
  ...
  <div class="col-lg-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="mt-0 header-title">Male Female Amount In Month Wise</h4>
                                <p class="text-muted mb-4 font-13">Fill the below details
                                </p>
...
<p><button class='Add_Popup' id="Add_Popup" style="display: none;">Add new row</button></p>
                                         <table id="datatable" class="table table-bordered dt-responsive nowrap assumptionwise_Amount" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
              <thead class="" >
                  <tr>                    
...
swal({
  title: "Are you sure?",
  text: "You will add Male and Female Count For Multiple combination Activity!",
  icon: "warning",
  buttons: true,
  dangerMode: true,
  className: "swal-back123"
})
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.8/js/select2.min.js" defer></script>
 ...
 <script src="assets/plugins/tiny-editable/mindmup-editabletable.js"></script>
        ...
        <script src="assets/pages/table-edit.init.js"></script>
